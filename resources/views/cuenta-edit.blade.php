...
<form action="{{route('cuentas.update', $cuenta->id)}}" method="post">
    ...
    <div class="mb-4">
        ...
        <input value="{{$cuenta->nombre_cuenta}}" name="nombre" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="cuenta_nombre" type="text" placeholder="Nombre de cuenta">
      </div>
      <div class="mb-6">
        ...
        <div class="relative inline-block w-full text-gray-700">
            <select id="naturaleza"  name="naturaleza" class="w-full h-10 pl-3 pr-6 text-base placeholder-gray-600 border rounded-lg appearance-none focus:shadow-outline" placeholder="Regular input">
              ...
              <option selected>Se carga</option>
              <option>Se abona</option>    
              @else
              <option>Se carga</option>
              <option selected>Se abona</option>    
              @endif
